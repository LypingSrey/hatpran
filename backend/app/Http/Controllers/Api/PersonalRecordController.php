...
class PersonalRecordController extends Controller
{
    public function index(Request $request): AnonymousResourceCollection
    {
        $records = $request->user()
            ->personalRecords()
            ->with(['exercise.muscleGroup', 'exerciseSet.workoutExercise.workout'])
    ...
    public function show(Request $request, PersonalRecord $personalRecord): PersonalRecordResource
    {
        ...
        return new PersonalRecordResource($personalRecord->load(['exercise.muscleGroup', 'exerciseSet.workoutExercise.workout']));
    }
